...
#-----------------------------------------------------------------------------
vendor_saved_apps := Bluetooth BluetoothMidiService HTMLViewer KeyChain PicoTts PrintSpooler Stk \
...
webview CMSettingsProvider telresources Snap
...
#-----------------------------------------------------------------------------
board_modify_apps := TeleService ConnectivitySettings SystemUI 
...
override_property += \
    ro.flyme.romer=andrw.gldmn \
    ro.product.model_romer=A536
